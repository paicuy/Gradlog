/*  Projekt: Temperaturlogger by Patrick Stucky
 *  Version: 2.1.2
 *
 *  Beschreibung:
...
//Benutzereinstellungen
     ...
     * Beispiel
     *
     *    Geraetename = "Neon";                           // Der Wert für den Gerätenamen und Raum muss in Anführunszeichen stehen (String)! 
     *    Raum =        "Stockwerk.Etage.Zweig.Raum";     // Semikolon darf nicht nicht vergeßen werden!
  ...
  //Geräteeinstellungen
  String Name = "Geraetename";
  String Raum = "Standort";
...
void drawScreen(bool stateWifi,bool stateMQTT) {
  ...
  do {
    ...
    u8g2.setCursor(8,46);
    // Ausgabe der Variable Float, 1 Nachkommastellen
